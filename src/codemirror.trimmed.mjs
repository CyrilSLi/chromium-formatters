var helpers = {}, modes = {}, mimeModes = {}, modeExtensions = {};
...
defineMode("javascript", function(config, parserConfig) {
  ...
  return {
    ...
    indent: function(state, textAfter) {
      if (state.tokenize == tokenComment || state.tokenize == tokenQuasi) return Pass;
...
function registerHelper(type, name, value) {
  if (!helpers.hasOwnProperty(type)) { helpers[type] = {_global: []}; }
