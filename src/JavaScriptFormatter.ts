...
import {AcornTokenizer, ECMA_VERSION, type TokenOrComment} from './AcornTokenizer.ts';
import {ESTreeWalker} from './ESTreeWalker.ts';
import type {FormattedContentBuilder} from './FormattedContentBuilder.ts';
