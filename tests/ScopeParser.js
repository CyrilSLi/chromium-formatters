...
import * as _FormatterWorker from '../src/FormatterWorker.ts';
import * as FormatterAction from '../src/FormatterActions.ts';
import { parseScopes } from '../src/ScopeParser.ts'; // Modified import to reference the actual function being tested
const FormatterWorker = {
    ..._FormatterWorker,
